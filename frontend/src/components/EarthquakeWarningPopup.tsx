  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-300 bg-opacity-70 z-50">
      ...
      <div className="bg-black p-6 rounded-lg shadow-lg z-10">
        ...
        <div>
          <p>
            The filters you applied in Earthquake filter are very broad and will generate {count} earthquakes.
            These large searches are costly for us to handle. Please consider refining your search criteria.
          </p>
